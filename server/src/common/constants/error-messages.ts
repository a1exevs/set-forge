export const ErrorMessages = {
  ...
  CONSENT_TO_PERSONAL_DATA_PROCESSING_IS_REQUIRED: 'Consent to the processing of personal data is required',
  TERMS_ACCEPTANCE_IS_REQUIRED: 'Acceptance of the Terms of Use is required',
